...
Namespace Migrations
    ...
    Public NotInheritable Partial Class Creacionnombreempleado
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Creacionnombreempleado))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201505241238148_Creacion-nombre-empleado"
            End Get
        End Property
